      ...
      <main className="flex-1 w-full bg-gradient-to-br from-blue-50 to-white pb-16">
        ...
        <section className="pt-32 pb-16 bg-gradient-to-r from-indigo-700 to-indigo-300 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">School Management Software</h1>
              <p className="text-xl mb-8">Simplify school administration, attendance, and communication with our all-in-one management platform.</p>
              <div className="flex flex-row items-center md:block">
                <button className="bg-white text-blue-700 font-bold px-8 py-4 rounded-xl shadow hover:bg-blue-100 transition-all duration-300" onClick={() => navigate('/contact')}>Start School Project</button>
        ...
        <section className="max-w-5xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-lg text-gray-700">
              ...
              <li>Customizable to fit your institution's needs</li>
              <li>Secure, cloud-based, and scalable</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-lg text-gray-700">
              <li>Student information management (attendance, homework, discipline, scores, etc.)</li>
              <li>Parent portal for communication and reports</li>
              <li>Assessment and assignment management</li>
              <li>Automated report cards and grade tracking</li>
              <li>Fee tracking and online payment</li>
              <li>Library, timetable, and transportation management</li>
