...
import { Code, Server, Database, TrendingUp, MonitorSmartphone, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-r from-green-900 to-green-400 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <Button size="lg" className="bg-white text-green-900 font-bold shadow hover:bg-green-100" onClick={() => navigate('/contact')}>Start Your Node.js Project</Button>
        </div>
      </section>
      {/* Features Section */}
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-8">
          <div className="bg-green-50 p-6 rounded-xl shadow hover:scale-105 transition-transform">
            <Server className="h-10 w-10 text-green-900 mb-2" />
            <h3 className="font-bold text-lg mb-2">Backend Power</h3>
            <p>High-performance APIs and microservices with Node.js.</p>
          </div>
          <div className="bg-green-50 p-6 rounded-xl shadow hover:scale-105 transition-transform">
            <Database className="h-10 w-10 text-green-900 mb-2" />
            <h3 className="font-bold text-lg mb-2">Real-Time Apps</h3>
            <p>Build chat, streaming, and IoT solutions with real-time data.</p>
          </div>
          <div className="bg-green-50 p-6 rounded-xl shadow hover:scale-105 transition-transform">
            <Code className="h-10 w-10 text-green-900 mb-2" />
            <h3 className="font-bold text-lg mb-2">Full-Stack JS</h3>
            <p>Unified JavaScript stack for seamless frontend and backend.</p>
          </div>
        </div>
      </section>
      {/* Why Choose Us */}
      <section className="py-16 bg-gradient-to-r from-green-100 to-green-200">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow flex flex-col items-center"><Server className="h-8 w-8 text-green-900 mb-2" />API Specialists</div>
            <div className="bg-white p-4 rounded-xl shadow flex flex-col items-center"><Database className="h-8 w-8 text-green-900 mb-2" />Real-Time Data</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-green-100 to-green-200">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8 text-center">Our Node.js Development Process</h2>
          <ol className="space-y-4">
            ...
            <li className="bg-white p-4 rounded-xl shadow flex items-center gap-4"><span className="font-bold text-green-900">3.</span> Custom Node.js Development</li>
      ...
      <section className="py-16 bg-gradient-to-r from-green-900 to-green-400 text-white text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <Button size="lg" className="bg-white text-green-900 font-bold shadow hover:bg-green-100" onClick={() => navigate('/contact')}>Get Started</Button>
        </div>
      </section>
      <Footer />
    </div>
