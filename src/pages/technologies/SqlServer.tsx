...
const faqs = [
  {
    ...
    a: 'Microsoft SQL Server is a relational database management system for storing and retrieving data as requested by other software.'
  },
  {
    q: 'Why use SQL Server for business?',
    a: 'SQL Server offers high performance, security, and integration with Microsoft products.'
  },
  {
    q: 'What services does SQL Server provide?',
    a: 'SQL Server provides database consulting, development, analytics, and cloud integration.'
  },
  {
    q: 'Is SQL Server cloud-ready?',
    a: 'Yes, SQL Server is available as a managed cloud service on Azure and other platforms.'
  }
];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex justify-center hidden sm:block">
              <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/microsoftsqlserver/microsoftsqlserver-plain.svg" alt="SQL Server" className="w-32 h-32 inline-block mx-2 bg-white rounded-xl p-2" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-8">
          <div className="bg-blue-50 p-6 rounded-xl shadow hover:scale-105 transition-transform">
            ...
            <p>SQL Server delivers high performance, reliability, and security for critical data.</p>
          </div>
          <div className="bg-blue-50 p-6 rounded-xl shadow hover:scale-105 transition-transform">
            <Code className="h-10 w-10 text-blue-900 mb-2" />
            <h3 className="font-bold text-lg mb-2">Advanced Analytics</h3>
            <p>Leverage built-in analytics and reporting tools for business intelligence.</p>
          </div>
          <div className="bg-blue-50 p-6 rounded-xl shadow hover:scale-105 transition-transform">
            <Database className="h-10 w-10 text-blue-900 mb-2" />
            <h3 className="font-bold text-lg mb-2">Cloud Integration</h3>
            <p>Integrate with Azure and other cloud platforms for scalable solutions.</p>
          </div>
        </div>
      </section>
      {/* Why Choose Us */}
      <section className="py-16 bg-gradient-to-r from-blue-100 to-blue-200">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Why Choose Infocera for SQL Server?</h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white p-4 rounded-xl shadow flex flex-col items-center"><TrendingUp className="h-8 w-8 text-blue-900 mb-2" />SQL Server Experts</div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-blue-100">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold mb-6 text-center">Our SQL Server Process</h2>
